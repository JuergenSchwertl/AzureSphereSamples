# AzureSphereSamples for 22.02 Azure Sphere SDK Version
...
Prerequisites:
Please make sure to have a Windows 10 laptop capable of running Visual Studio 2022 or Visual Studio Code with the Azure Sphere SDK 
